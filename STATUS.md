...
| 08 测试与质量 | [总纲](模块/08_测试与质量_总纲.md) | ✅ 已实现 | 86 套件 0 失败；缺完整 E2E |
...
- **测试**：`npm test` 整链 **86 套件 0 失败**（含 AK=PDF 表单字段提取 34 断言、AL=PDF 文档信息/元数据提取 33 断言、AM=PDF 页面属性/页面树信息提取 50 断言、AN=PDF 字体信息提取 74 断言；_updater_autoupdate_test 11 断言锁定 v1.0.15 自动更新正向链路）。
